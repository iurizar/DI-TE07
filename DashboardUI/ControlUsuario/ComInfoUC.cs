...
namespace DashboardUI.ControlUsuario
{
    public partial class ComInfoUC : UserControl
    {
        ...
        public ComInfoUC(ComercialVO comercial)
        {
            ...
            this.toolTipInfo.SetToolTip(labelNum, "Identificador del comercial");
            this.toolTipInfo.SetToolTip(labelNom, "Nombre del comercial");
            this.toolTipInfo.SetToolTip(labelAge, "Edad del comercial");
            this.toolTipInfo.SetToolTip(labelLoc, "Residencia del comercial");
            this.toolTipInfo.SetToolTip(fotoPerfil, "Fotografía del comercial");
        }
